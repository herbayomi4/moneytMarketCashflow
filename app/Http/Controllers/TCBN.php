    ...
    */
    ...
    public function export(Request $request) 
    {
        ...
        $excel->getActiveSheet()
            ...
            $excel->getActiveSheet()
            ->setCellvalue('A6', 'TAKINGS FROM CBN')
            ...
            ->setCellvalue('I12', 'Interest Payable')
            ->setCellvalue('J12', 'Interest Expense')
            ->setCellvalue('K12', 'Status');

            $excel->getActiveSheet()
                ->setCellvalue('H11', '5122')
                ->setCellvalue('I11', '4134')
                ->setCellvalue('J11', '9139');
        ...
        $objDrawing->setWorksheet($excel->getActiveSheet()); 
            ...
            header('Content-Disposition: attachment; filename= "Takings from CBN"'.$reporting_date.'".xlsx"');
    ...
    */
    ...
    public function import(Request $request) 
    {
        ...
        if($excel->getCell('B10')->getValue() =="CBN"){
            DB::table('cashflow_cbn_takings')->delete();
